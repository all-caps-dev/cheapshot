...
Everything cheapshot stands on, with links. Becomes the credits page of the docs site. Add a line whenever a dependency, tool, or borrowed idea arrives.
...
- [lucode-starlight](https://www.npmjs.com/package/lucode-starlight) theme.
